...
class DetailJanjiDokter extends StatefulWidget {
  const DetailJanjiDokter({super.key});

  @override
  State<DetailJanjiDokter> createState() => _DetailJanjiDokterState();
}

class _DetailJanjiDokterState extends State<DetailJanjiDokter> {
  @override
